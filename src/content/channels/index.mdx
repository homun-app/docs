...
<Callout type="info">
Choosing the right channel depends on your use case. You can enable multiple channels simultaneously — they all share the same agent loop, memory, and tools.
</Callout>
...
Every channel enforces authentication before accepting messages. Make sure to configure authentication for any channel exposed to untrusted users.
</Callout>
...
<Cards>
  ...
  <Cards.Card title="WhatsApp" href="/channels/whatsapp" />
  <Cards.Card title="Discord" href="/channels/discord" />
  <Cards.Card title="Slack" href="/channels/slack" />
  <Cards.Card title="Email" href="/channels/email" />
  <Cards.Card title="Web UI" href="/channels/web" />
  <Cards.Card title="CLI" href="/channels/cli" />
</Cards>
