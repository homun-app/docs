...
<Callout type="info">
The chat supports multiple concurrent sessions, letting you keep conversations organized by topic or task. Sessions are stored in SQLite and persist across gateway restarts. Sessions from all channels (CLI, Telegram, Web, etc.) are visible in the sidebar.
</Callout>
