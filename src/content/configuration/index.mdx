...
<FileTree>
  <FileTree.Folder name="~/.homun/" defaultOpen>
    <FileTree.File name="config.toml" />
    <FileTree.File name="homun.db" />
    <FileTree.File name="homun.db-shm" />
    <FileTree.File name="homun.db-wal" />
    <FileTree.File name="secrets.enc" />
    <FileTree.Folder name="brain" defaultOpen>
      <FileTree.File name="USER.md" />
      <FileTree.File name="INSTRUCTIONS.md" />
      <FileTree.File name="SOUL.md" />
    </FileTree.Folder>
    <FileTree.Folder name="memory">
      <FileTree.File name="2025-01-15.md" />
      <FileTree.File name="2025-01-16.md" />
    </FileTree.Folder>
    <FileTree.Folder name="skills">
      <FileTree.Folder name="weather">
        <FileTree.File name="SKILL.md" />
        <FileTree.Folder name="scripts">
          <FileTree.File name="fetch.py" />
        </FileTree.Folder>
      </FileTree.Folder>
      <FileTree.Folder name="summarizer">
        <FileTree.File name="SKILL.md" />
      </FileTree.Folder>
    </FileTree.Folder>
    <FileTree.Folder name="logs">
      <FileTree.File name="homun.log" />
    </FileTree.Folder>
...
<Callout type="warning">
Do not manually edit `homun.db` or `secrets.enc`. Use the CLI, API, or Web UI for all data operations. Editing the database directly can corrupt your data. The `brain/` files and `config.toml` are safe to edit manually.
</Callout>
...
<Callout type="info">
Some settings take effect immediately while the gateway is running. Others require a full restart. Provider settings, general settings, and sandbox settings hot-reload. Channel settings and security settings require a gateway restart.
</Callout>
...
<Callout type="warning">
Homun validates the configuration file at startup and when settings are changed via CLI or API. If validation fails, Homun prints a clear error message and exits with a non-zero status code. It never starts with an invalid configuration.
</Callout>
...
<Callout type="info">
Below is a complete `config.toml` with all sections. Uncomment and modify the sections you need. The only required setting is `providers.default`.
</Callout>
